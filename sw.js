const CACHE="ubereats-progress-v29";
const ASSETS=["./?v=29","index.html?v=29","compact.html","manifest.webmanifest","apple-touch-icon.png","assets/favicon-32.png","assets/icon-192.png","assets/icon-512.png","assets/delivery-scooter.png"];
