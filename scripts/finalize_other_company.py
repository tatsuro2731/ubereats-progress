...
replace_exact(
    "README.md",
    '- 稼働計測の「時計が減った時間」は`12時間 − 現在の残り時間`と連携し、実稼働率はその時間を休憩除外後の経過時間で割って計算します。残り時間を補正した場合も同じ値へ反映されます。',
...
replace_exact(
    "index.html",
    '<script src="app-enhancements.js?v=6"></script>',
    '<script src="app-enhancements.js?v=7"></script>',
)
replace_exact(
    "index.html",
    '<script src="app-session-ui-fix.js?v=7"></script>',
    '<script src="app-session-ui-fix.js?v=8"></script>',
)
replace_exact(
    "compact.html",
    'navigator.serviceWorker.register("sw.js?v=46")',
...
test_path = Path("tests/timer-engine.test.js")
test_text = test_path.read_text(encoding="utf-8")
marker = 'test("reset offers to save an other-company-only session"'
