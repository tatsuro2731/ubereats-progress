const CACHE="ubereats-progress-v31";
const ASSETS=["./?v=31","index.html?v=31","compact.html","manifest.webmanifest","apple-touch-icon.png","assets/favicon-32.png","assets/icon-192.png","assets/icon-512.png","assets/delivery-scooter.png"];
