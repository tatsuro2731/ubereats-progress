const CACHE="ubereats-progress-v19";
const ASSETS=["./","index.html","compact.html","manifest.webmanifest","apple-touch-icon.png","assets/favicon-32.png","assets/icon-192.png","assets/icon-512.png"];
