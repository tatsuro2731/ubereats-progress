const CACHE="ubereats-progress-v24";
const ASSETS=["./?v=24","index.html?v=24","compact.html","manifest.webmanifest","apple-touch-icon.png","assets/favicon-32.png","assets/icon-192.png","assets/icon-512.png","assets/delivery-scooter.png"];
